...
export default async function Home() {
  const [latestProjects, homepageFeaturedOverride, heroBackgrounds] = await Promise.all([
    getLatestProjectsForGallery(),
    getHomepageFeaturedProjectFromSettings(),
    getHomepageHeroBackgrounds(),
  ]);
  ...
  return (
    <main id="main-content" className="min-h-screen bg-stone-white">
      ...
      <HeroSection
        backgroundSrcDesktop={heroBackgrounds?.desktop}
        backgroundSrcMobile={heroBackgrounds?.mobile}
      >
